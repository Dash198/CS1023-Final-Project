...
\begin{itemize}
    ...
    \end{itemize}
    \item Alternatively, ensure that the \texttt{raw\_source} folder and \texttt{MIA.java} are in the same directory. Compile the source code inside the folder, and then compile \texttt{MIA.java}, and run it as shown:\\\texttt{java MIA <int/float> <add/sub/mul/div> <op1> <op2>}
\end{itemize}
